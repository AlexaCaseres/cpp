     ...
     switch (opcion)
    {
        ...
        case 2:
        {
            ...
            cin >> opcionProducto;
                ...
                {
                    case 1:
                    agregarProducto (" 1 Te L 30.00 ", 1, 40);
                    break;

                    case 2:
                    agregarProducto (" 1 Jugo de Naranja - L 35.00 ", 1, 25);
                    break;
        ...
        case 3:
        {
            ...
            cin >> opcionProducto;
                ...
                {
                    case 1:
                    agregarProducto (" 1 Muffins de Chocolate L 50.00 ", 1, 40);
                    break;

                    case 2:
                    agregarProducto (" 1 Tres Leches - L 30.00 ", 1, 25);
                    break;
